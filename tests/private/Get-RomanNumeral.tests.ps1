...
Describe "STRY0000009_Get-RomanNumeral" {
  Context "STRY0000013_Simple Calculations" {
      ...
      It "Calculates the Roman Numeral for 10" {
          Get-RomanNumeral -Number 10 | Should be "XX"
      }
    ...
    Context "STRY0000031_Complex Calculations" {
